...
/**
 * Class that holds a reference to an OnClickListener set to button type
 * SuperActivityToasts/SuperCardToasts. This is used for restoring listeners on
 * orientation changes.
 */
public class OnClickWrapper implements SuperToast.OnClickListener {
   ...
   * 
   * @param tag
   *          {@link CharSequence} Must be unique to this listener
   * @param onClickListener
   *          {@link com.ruint.core.view.supertoasts.SuperToast.OnClickListener}
   */
   ...
   * reattach {@link com.ruint.core.view.supertoasts.SuperToast.OnClickListener}
   * .
   * 
   * @return {@link String}
   */
