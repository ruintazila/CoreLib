...
import com.ruint.core.app.BaseApplication;
import com.ruint.core.utils.preferences.CorePreferences;
import com.ruint.core.utils.ui.AlertUtils;
  ...
  */
  ...
  private boolean handleException(final Throwable ex) {
    ...
    new Thread() {
      ...
      public void run() {
        Looper.prepare();
        AlertUtils.showSimpleAlertDialog(mContext, "警告", "程序发生致命异常,请检查系统版本是否兼容或者联系我们！", SweetAlertDialog.ERROR_TYPE,
            new OnSweetClickListener() {

              @Override
              public void onClick(SweetAlertDialog sweetAlertDialog) {
                try {
                  ((BaseApplication) mContext).onTerminate();
                  System.exit(0);
                } catch (Exception e) {
                }
              }
