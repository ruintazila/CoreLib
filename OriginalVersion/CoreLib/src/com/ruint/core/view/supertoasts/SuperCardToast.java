...
import com.ruint.core.view.supertoasts.util.SwipeDismissListener;
 ...
 */
public class SuperCardToast extends SuperToastUtero {
  ...
  /**
   * Returns the {@link com.ruint.core.view.supertoasts.SuperToast.Type} of
   * {@value #TAG}.
   * 
   ...
   *          {@link CharSequence}
   */
  public SuperCardToast setText(CharSequence text) {
   ...
   */
  public SuperCardToast setTextColor(int textColor) {
   ...
   *          int
   */
  public SuperCardToast setTextSize(int textSize) {
   ...
   */
  public SuperCardToast setDuration(int duration) {
   ...
   */
  public SuperCardToast setIcon(int icon, IconPosition iconPosition) {
    ...
    if (iconPosition == IconPosition.BOTTOM) {
      ...
      mMessageTextView.setCompoundDrawablesWithIntrinsicBounds(null, null, null,
          mActivity.getResources().getDrawable(icon));

    } else if (iconPosition == IconPosition.LEFT) {

      mMessageTextView.setCompoundDrawablesWithIntrinsicBounds(mActivity.getResources().getDrawable(icon), null, null,
          null);

    } else if (iconPosition == IconPosition.RIGHT) {

      mMessageTextView.setCompoundDrawablesWithIntrinsicBounds(null, null, mActivity.getResources().getDrawable(icon),
          null);

    } else if (iconPosition == IconPosition.TOP) {

      mMessageTextView.setCompoundDrawablesWithIntrinsicBounds(null, mActivity.getResources().getDrawable(icon), null,
          null);
   ...
   */
  public SuperCardToast setBackground(int background) {
   ...
   */
  public SuperCardToast setAnimations(Animations animations) {
  ...
  public void setSwipeToDismiss(boolean swipeDismiss) {
    ...
    if (swipeDismiss) {
      ...
      if (Build.VERSION.SDK_INT > Build.VERSION_CODES.HONEYCOMB_MR1) {
        ...
        final SwipeDismissListener swipeDismissListener = new SwipeDismissListener(mToastView,
   ...
   */
  public SuperCardToast setOnDismissWrapper(OnDismissWrapper onDismissWrapper) {
   ...
   */
  public SuperCardToast setOnClickWrapper(OnClickWrapper onClickWrapper) {
  ...
  private Animation getShowAnimation() {
    ...
    if (this.getAnimations() == Animations.FLYIN) {
      ...
      TranslateAnimation translateAnimation = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 0.75f,
      ...
      ScaleAnimation scaleAnimation = new ScaleAnimation(0.9f, 1.0f, 0.9f, 1.0f, Animation.RELATIVE_TO_SELF, 0.5f,
      ...
      TranslateAnimation translateAnimation = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 0.0f,
          Animation.RELATIVE_TO_SELF, 0.0f, Animation.RELATIVE_TO_SELF, 0.1f, Animation.RELATIVE_TO_SELF, 0.0f);
  ...
  private Animation getDismissAnimation() {
    ...
    if (this.getAnimations() == Animations.FLYIN) {
      ...
      TranslateAnimation translateAnimation = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 0.0f,
          Animation.RELATIVE_TO_SELF, .75f, Animation.RELATIVE_TO_SELF, 0.0f, Animation.RELATIVE_TO_SELF, 0.0f);
      ...
      ScaleAnimation scaleAnimation = new ScaleAnimation(1.0f, 0.9f, 1.0f, 0.9f, Animation.RELATIVE_TO_SELF, 0.5f,
          Animation.RELATIVE_TO_SELF, 0.5f);
      ...
      TranslateAnimation translateAnimation = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 0.0f,
          Animation.RELATIVE_TO_SELF, 0.0f, Animation.RELATIVE_TO_SELF, 0.0f, Animation.RELATIVE_TO_SELF, 0.1f);
  ...
  private SuperCardToast(Activity activity, ReferenceHolder referenceHolder, Wrappers wrappers, int position) {
    ...
    if (referenceHolder.mType == Type.BUTTON) {
      ...
      /*
       * PROGRESS_HORIZONTAL style SuperCardToasts should be managed by the
       * developer
       */
