 ...
 */
public class SuperToast extends SuperToastUtero {
  ...
  /**
   * Custom OnClickListener to be used with SuperActivityToasts/SuperCardToasts.
   * Note that SuperActivityToasts/SuperCardToasts must use this with an
   ...
   *          {@link CharSequence}
   */
  public SuperToast setText(CharSequence text) {
   ...
   */
  public SuperToast setTextColor(int textColor) {
  ...
  public SuperToast setIcon(int iconResource, IconPosition iconPosition) {
    ...
    if (iconPosition == IconPosition.BOTTOM) {
      ...
      mMessageTextView.setCompoundDrawablesWithIntrinsicBounds(mContext.getResources().getDrawable(iconResource), null,
          null, null);
      ...
      mMessageTextView.setCompoundDrawablesWithIntrinsicBounds(null, mContext.getResources().getDrawable(iconResource),
          null, null);
   ...
   */
  public SuperToast setAnimations(Animations animations) {
   ...
   *          {@link com.ruint.core.view.supertoasts.SuperToast.OnDismissListener}
   */
   ...
   * 
   * @return {@link com.ruint.core.view.supertoasts.SuperToast.OnDismissListener}
   */
  ...
  @Deprecated
  @Override
  protected SuperToastUtero setOnClickWrapper(OnClickWrapper clickWrapper) {
    return this;
  }

  @Deprecated
  @Override
  protected SuperToastUtero setOnDismissWrapper(OnDismissWrapper dismissWrapper) {
    return null;
  }
