/*
 * BitmapLoader.java
 * classes : com.ruint.core.utils.bitmap.BitmapLoader
 * @author ruint
 * V 1.0.0
...
import com.ruint.core.cache.bitmap.FileNameGenerator;
import com.ruint.core.task.PriorityAsyncTask;
import com.ruint.core.task.PriorityExecutor;
import com.ruint.core.task.TaskHandler;
import com.ruint.lib.bitmaploader.BitmapCacheListener;
import com.ruint.lib.bitmaploader.BitmapCommonUtils;
import com.ruint.lib.bitmaploader.BitmapDisplayConfig;
import com.ruint.lib.bitmaploader.BitmapGlobalConfig;
import com.ruint.lib.bitmaploader.callback.BitmapLoadCallBack;
import com.ruint.lib.bitmaploader.callback.BitmapLoadFrom;
import com.ruint.lib.bitmaploader.callback.DefaultBitmapLoadCallBack;
import com.ruint.lib.bitmaploader.core.AsyncDrawable;
import com.ruint.lib.bitmaploader.core.BitmapSize;
import com.ruint.lib.bitmaploader.download.Downloader;

/**
 * com.ruint.core.utils.bitmap.BitmapLoader
 * 
 * @author ruint <br/>
 *         create at 2014-11-25 上午11:10:50
 */
...
public class BitmapLoader implements TaskHandler {
  ...
  public <T extends View> void display(T container, String uri, BitmapDisplayConfig displayConfig,
    ...
    displayConfig
        .setBitmapMaxSize(BitmapCommonUtils.optimizeMaxSizeByView(container, size.getWidth(), size.getHeight()));
