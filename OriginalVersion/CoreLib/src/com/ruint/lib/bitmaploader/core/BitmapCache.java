...
import com.ruint.core.cache.bitmap.LruDiskCache;
import com.ruint.core.cache.bitmap.LruMemoryCache;
import com.ruint.core.utils.IOUtils;
import com.ruint.core.utils.LogUtils;
import com.ruint.core.utils.OtherUtils;
import com.ruint.core.utils.bitmap.BitmapLoader;
import com.ruint.lib.bitmaploader.BitmapDisplayConfig;
import com.ruint.lib.bitmaploader.BitmapGlobalConfig;
import com.ruint.lib.bitmaploader.factory.BitmapFactory;
      ...
      try {
        ...
        if (snapshot != null) {
          ...
          if (config == null || config.isShowOriginal()) {
            ...
            bitmap = BitmapDecoder.decodeSampledBitmapFromDescriptor(snapshot.getInputStream(DISK_CACHE_INDEX).getFD(),
